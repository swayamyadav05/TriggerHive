/*
  ...
  - Added the required column `updatAt` to the `Workflow` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "updatAt" TIMESTAMP(3) NOT NULL,
